...
import type {BatchTestNamingInput, BatchTestNamingOutput, GeneratedTestName, Resume, TestNamingContext} from "./types"
...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async GenerateTestName(
        context: types.TestNamingContext,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.GeneratedTestName> {
          try {
          const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
          const __signal__ = __options__.signal;
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.GenerateTestName(
          context,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.GeneratedTestName
            } catch (error) {
            throw toBamlError(error);
            }
            }
            
        async GenerateTestNamesBatch(
        input: types.BatchTestNamingInput,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.BatchTestNamingOutput> {
          try {
          const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
          const __signal__ = __options__.signal;
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.GenerateTestNamesBatch(
          input,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.BatchTestNamingOutput
            } catch (error) {
            throw toBamlError(error);
            }
            }
            ...
            context: types.TestNamingContext,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.GeneratedTestName, types.GeneratedTestName>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for GenerateTestName", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.GeneratedTestName, types.GeneratedTestName>(
                  __raw__,
                  (a): partial_types.GeneratedTestName => a,
                  (a): types.GeneratedTestName => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            input: types.BatchTestNamingInput,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.BatchTestNamingOutput, types.BatchTestNamingOutput>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for GenerateTestNamesBatch", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.BatchTestNamingOutput, types.BatchTestNamingOutput>(
                  __raw__,
                  (a): partial_types.BatchTestNamingOutput => a,
                  (a): types.BatchTestNamingOutput => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
